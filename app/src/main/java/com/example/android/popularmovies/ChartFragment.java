...
import com.example.android.personalview.MyRecyclerView;
import com.example.android.imitation.GridAdapter;
import com.example.android.imitation.GridItem;
import com.example.android.imitation.GridDesign;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        movieGrid.addOnItemTouchListener(new MyRecyclerView.OnItemClickListener() {
            ...
            public void onClick(View V, int position) {
                Intent I=new Intent(getActivity(),ElementActivity.class);
    ...
    {  @Override
        protected ArrayList<GridItem> doInBackground(String... params) {
            ...
            {   SharedPreferences preference= PreferenceManager.getDefaultSharedPreferences(context);
                String sort=preference.getString(GridDesign.SORT_KEY,getResources().getString(R.string.sort_default));
                switch(sort)
                ...
                reqUri.appendQueryParameter("api_key", GridDesign.API_KEY);
